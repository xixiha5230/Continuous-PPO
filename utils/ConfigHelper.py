...
class ConfigHelper:
    def __init__(self, config_file) -> None:
        ...
        self.entropy_coeff_schedule: dict = conf_ppo.setdefault('entropy_coeff_schedule', self.entropy_coeff_schedule)
        ...
        self.clip_range_schedule: dict = conf_ppo.setdefault('clip_range_schedule', self.clip_range_schedule)
