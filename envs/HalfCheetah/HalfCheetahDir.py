...
class HalfCheetahDir(HalfCheetahBace):
    ...
    def __init__(self, task={}, render_mode=None):
        super(HalfCheetahDir, self).__init__()
        self._task = task
        self.render_mode = render_mode
        self._goal_dir = task.setdefault("direction", 1)
        self._one_hot = task.setdefault("one_hot", [0])
        self.observation_space = Tuple(
            [
                Box(
                    float("-inf"), float("inf"), (len(super()._get_obs()),), np.float32
                ),
